...
HTML 기본 구조는 `html<!DOCTYPE html>, <html>, <head>, <body>`으로 구성됩니다.
...
`html<head>`는 웹페이지의 정보를 담는 부분입니다.
화면에 보이는게 아닌, 검색엔진이 이해하는 정보들이 들어갑니다.
예를 들면 `html<title>,<meta>,<link>`등이 있습니다.

마지막으로 `html<body>`는 실제로 화면에 표시되는 콘텐츠가 들어가는 부분입니다.
